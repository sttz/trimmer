...
public class BuildRunner : ScriptableObject
{
    ...
    /// </summary>
    public void Run(Job[] jobs, IBuildsCompleteListener listener)
    {
        EnsureNotRunning();
    ...
    void Complete(bool success)
    {
        ...
        this.results = null;
        this.jobIndex = -1;
        this.switchingActiveTarget = false;
